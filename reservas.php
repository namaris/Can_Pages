    ...
    <div class="row-top">
      ...
      <nav>
        <ul class="sf-menu">
          ...
          <li><a href="menu.html">CARTA</a>
            <ul>
              <li><a href="#">MENUS ESPECIALES</a></li>
              <li><a href="#">VINOS</a>
...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com. December03, 2012!</div>
  ...
  <div class="container_12">
    <article class="side-bar extra">
      <h3><strong>3</strong> pasos <em>para<br>
        realizar tu reserva</em></h3>
      <ul class="list-dropcap1">
        ...
        <li>
          <div class="wrapper">
            ...
            <h4>para cuantas personas?</h4>
          </div></li>
        <li>
          <div class="wrapper">
            <div class="dropcap">3</div>
            <h4>desea confirmaciÓn telefÓnica?</h4>
          </div>
          <p>&nbsp;</p>
        </li>
      </ul>
